...
const CLIENT_TYPES = new Set([
  ...
  'learning_action_viewed', 'activity_resumed', 'next_action_started',
...
const METADATA_FIELDS = {
  ...
  learning_action_viewed: new Set(['source', 'actionType', 'mode']),
  activity_resumed: new Set(['source', 'mode', 'currentIndex']),
  next_action_started: new Set(['source', 'actionType', 'mode']),
