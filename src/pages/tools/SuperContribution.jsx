...
const SuperContribution = () => {
  ...
  return (
    <CalculatorShell
      category="Retirement"
      title={<>Legacy <br />Architecture.</>}
      description="Project your superannuation maturity and optimize contribution discipline for long-term equity."
    >
      ...
      <CalculatorResultPanel title="Maturity Projection">
