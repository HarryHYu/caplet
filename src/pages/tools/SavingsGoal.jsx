  ...
  return (
    <CalculatorShell>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-px bg-line-soft border border-line-soft reveal-text stagger-1">
          <CalculatorCard title="Objective Parameters">
          ...
          <ResultPanel title="Temporal Projection" result={result} emptyIcon="GOAL" emptyMessage="Enter your goal to see results">
            {result ? (
              result.error ? (
