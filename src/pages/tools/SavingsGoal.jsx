...
const SavingsGoal = () => {
  ...
  return (
    <CalculatorShell
      category="Objectives"
      title={<>Target <br />Architecture.</>}
      description="Define your capital objectives and calculate the temporal distance to maturity."
    >
      <CalculatorFormPanel title="Objective Parameters">
        <form onSubmit={handleSubmit} className="space-y-16">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                <FormRow label="Target Capital (AUD)" prefix="$">
                    <input
                      type="number"
                      min="0"
                      step="100"
      ...
      <CalculatorResultPanel title="Temporal Projection">
