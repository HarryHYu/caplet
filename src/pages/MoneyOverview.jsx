...
export default function MoneyOverview() {
  ...
  const selected = useMemo(
    () => intentById(selectedIntent, myMoneyAvailable),
    [myMoneyAvailable, selectedIntent],
  );
  ...
  return (
    <div className="min-h-screen bg-surface-body pb-32 pt-28 selection:bg-accent selection:text-white md:pt-32 lg:pb-20">
      <div className="container-custom">
        ...
        {moneyNotice ? <div role="status" className="mb-8 rounded-2xl bg-accent-soft px-5 py-4 text-sm font-bold leading-relaxed text-accent">{moneyNotice}</div> : null}
