    ...
    <div className="minimal-page selection:bg-accent selection:text-accent-contrast">
      <div className="container-custom">
        ...
        <div className="reveal-stagger mt-8 grid gap-6 lg:grid-cols-12">
          <Link to="/money/economy/inflation" className="group rounded-3xl bg-[color:var(--block-blue)] p-7 transition-[box-shadow,transform] duration-300 hover:-translate-y-1 hover:shadow-glow lg:col-span-7 md:p-9">
          ...
          <section className="rounded-3xl bg-surface-raised p-7 shadow-card transition-[box-shadow,transform] duration-300 hover:-translate-y-1 hover:shadow-card-hover lg:col-span-5 md:p-9" aria-labelledby="my-money-preview-title">
