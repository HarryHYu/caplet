...
function ReportImportDialog({ subjects, onCancel, onImport }) {
  ...
  return (
    <div className="fixed inset-0 z-[80] grid place-items-center bg-black/50 p-4" onMouseDown={(event) => !parsing && event.target === event.currentTarget && onCancel()}>
      <section ref={dialogRef} tabIndex="-1" role="dialog" aria-modal="true" aria-labelledby="report-import-title" className="max-h-[92vh] w-full max-w-3xl overflow-y-auto rounded-xl border border-line-soft bg-surface-body p-6 shadow-2xl">
    ...
    <div className="min-h-screen bg-surface-body pb-24 pt-24 text-text-primary md:pt-28">
      <div className="container-custom max-w-6xl">
        ...
        <section className="mt-12 border-t border-line-soft pt-10" aria-labelledby="results-insights-heading">
          ...
          </div> : <div className="mt-6 rounded-xl border border-dashed border-line-soft px-6 py-10 text-center"><p className="font-bold">Your charts will appear after you log a result.</p><p className="mt-2 text-sm text-text-muted">Add marks manually or import a school report.</p></div>}
        </section>
      </div>
