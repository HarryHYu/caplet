  ...
  return (
    <div className="minimal-page">
      <div className="container-custom">
        ...
        <section className="mt-6 grid gap-4 sm:grid-cols-3" aria-label="Assessment result summary"><div className="surface-card animate-rise"><p className="card-section-title mb-0">Results logged</p><p className="mt-3 font-display text-4xl font-extrabold">{visible.length}</p></div><div className="surface-card animate-rise" style={{ animationDelay: '70ms' }}><p className="card-section-title mb-0">Average result</p><p className="mt-3 font-display text-4xl font-extrabold">{average === null ? '—' : `${average}%`}</p></div><div className="surface-card animate-rise" style={{ animationDelay: '140ms' }}><p className="card-section-title mb-0">Weighting covered</p><p className="mt-3 font-display text-4xl font-extrabold">{totalWeight}%</p></div></section>

        <section className="surface-card mt-6" aria-labelledby="results-table-heading">
        ...
        <section className="surface-card mt-6" aria-labelledby="results-insights-heading">
