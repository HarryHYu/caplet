  ...
  return (
    <div className="min-h-screen bg-surface-body pb-32 pt-28 selection:bg-accent selection:text-accent-contrast md:pt-32 lg:pb-20">
      <div className="container-custom">
        ...
        <section className="surface-card mt-8 overflow-hidden md:p-8" aria-labelledby="cpi-card-title">
          <div className="flex flex-col gap-7 lg:flex-row lg:items-start lg:justify-between">
            ...
            <div className="min-w-56 rounded-2xl border border-line-soft bg-[color:var(--block-blue)] p-6">
        ...
        <section className="surface-card mt-6 bg-[color:var(--block-cream)] md:p-8" aria-labelledby="inflation-explainer-title">
