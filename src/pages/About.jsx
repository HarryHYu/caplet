            ...
            <div className="mb-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="text-center p-6 bg-gray-50 rounded-lg">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">Personal Wellbeing</h3>
                ...
                <div className="text-center p-6 bg-gray-50 rounded-lg">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">Economic Participation</h3>
                  <p className="text-gray-600 text-sm">
                ...
                <div className="text-center p-6 bg-gray-50 rounded-lg">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">Financial Security</h3>
                  <p className="text-gray-600 text-sm">
