  ...
  return (
    <div className="minimal-page">
      <div className="container-custom">
        ...
        <div className="animate-rise-slow mt-10 grid gap-10 border-t border-line-soft pt-10 md:grid-cols-[1.3fr_0.7fr] md:items-start md:gap-16">
          ...
          <aside className="border-l border-line-soft pl-6">
            ...
            <div className="mt-5 flex flex-col gap-3 text-sm font-bold">
              <Link to="/courses" className="btn-primary press focus-ring">Browse Courses</Link>
              <Link to="/trust" className="btn-secondary press focus-ring">Read the Trust Center</Link>
              <Link to="/contact" className="btn-secondary press focus-ring">Get in touch</Link>
            </div>
          </aside>
        </div>
      </div>
