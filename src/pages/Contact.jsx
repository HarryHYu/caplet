  ...
  return (
    <div className="minimal-page">
      <div className="container-custom">
        ...
        <div className="grid border-y border-line-soft md:grid-cols-2">
          <section className="py-10 md:pr-12" aria-labelledby="contact-email">
            ...
            <a href="mailto:contact@caplet.org" className="mt-8 inline-block text-lg font-bold text-accent hover:text-accent-strong">contact@caplet.org</a>
          </section>
          ...
          <section className="border-t border-line-soft py-10 md:border-l md:border-t-0 md:pl-12" aria-labelledby="contact-help">
            ...
            <Link to="/trust" className="mt-8 inline-block text-sm font-bold text-accent">Read the Trust Center</Link>
          </section>
        </div>
      </div>
    </div>
