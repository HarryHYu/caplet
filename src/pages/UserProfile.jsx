...
const UserProfile = () => {
  ...
  // Match Settings: unauthenticated visitors are redirected declaratively.
  if (!isAuthenticated) {
      ...
      <div className="container-custom">
        <div className="max-w-2xl mx-auto reveal">
          <button
            type="button"
            onClick={() => navigate(-1)}
            className="focus-ring press group mb-12 inline-flex items-center gap-2 rounded-lg text-sm font-bold text-text-dim transition-colors hover:text-accent"
          >
            ← Back
          </button>
          ...
          <div className="bg-surface-raised rounded-3xl p-12 lg:p-16 shadow-card">
            <div className="flex flex-col md:flex-row items-start md:items-center gap-10 mb-12">
              <div className="w-24 h-24 rounded-2xl bg-accent text-accent-contrast flex items-center justify-center text-4xl font-display font-extrabold tracking-tight shadow-pop">
                {initials}
              </div>
              <div>
