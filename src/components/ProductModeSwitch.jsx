  ...
  return (
    <div
      ...
      className={`${collapsed
        ...
        : 'grid grid-cols-2 gap-0.5 rounded-xl border border-line-soft bg-surface-soft p-1 shadow-card'} ${className}`}
    >
      {[
        ...
        return (
          <button
            ...
            } ${collapsed ? 'h-8 w-8 rounded-full p-0 text-[10px] press' : 'h-8 min-w-0 rounded-lg px-2 press'}`}
          >
