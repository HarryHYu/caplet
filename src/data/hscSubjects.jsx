...
const facultyStyles = [
  { name: 'English', block: 'block-blue', text: 'text-blue' },
  { name: 'Mathematics', block: 'block-green', text: 'text-green' },
  { name: 'Humanities & Commerce', block: 'block-coral', text: 'text-coral' },
  { name: 'Languages', block: 'block-blue', text: 'text-blue' },
  { name: 'Creative Arts', block: 'block-amber', text: 'text-amber' },
  { name: 'Health & Movement', block: 'block-green', text: 'text-green' },
  { name: 'Sciences', block: 'block-amber', text: 'text-amber' },
  { name: 'Technology', block: 'block-coral', text: 'text-coral' },
];

export const faculties = facultyStyles.map((faculty) => ({
  ...faculty,
  subjects: subjectCatalog
    .filter((subject) => subject.faculty === faculty.name)
    .map((subject) => ({
      ...subject,
      glyph: glyphs[subject.glyph] || glyphs.english,
    })),
}));
